...
- (void)setupNavBar{
    ...
    NSDictionary *parentInfo = self.contractObject[@"jobinfo"][@"parent"];
...
- (void)setupUI{
    ...
    NSDictionary *parentInfo = jobInfo[@"parent"];

    // profile image
    NSString *photoUrl = parentInfo[PHOTO_FIELD];
    ...
    self.locLabel.text = [jobInfo objectForKey:@"location"];

//    [NSString stringWithFormat:@"%@, %@", [jobInfo[@"parent"] objectForKey:@"city"],
//                          [jobInfo[@"parent"] objectForKey:@"state"]];
...
- (IBAction)SendInvoice:(id)sender{
    ...
    [self sendEmail:parentInfo[@"email"] toName:parentInfo[@"firstname"] senderEmail:senderInfo[@"email"] senderName:senderInfo[@"firstname"] subject:@"Invoice" content:_invoiceTxtView.text];
       ...
       parameters:@{@"from": fromEmail,
          ...
          success:^(AFHTTPRequestOperation *operation, id responseObject) {
              ...
              if ([responseObject[@"result"] intValue] == 1){
                  ...
                  [[AppDelegate sharedInstance] showAlertMessage:@"Success" message:@"Invoice is sent successfully." buttonTitle:@"Ok"];
